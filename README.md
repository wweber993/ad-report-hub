...
### 2. Manual Installation (Linux / macOS)

If you are not on Windows, you can install the platform manually:
...
cp .env.example .env
# Edit .env to set your INGEST_TOKEN and PORT
...
#### Production Mode (Gunicorn/Linux):
```bash
